    ...
    <header>
      <div class="wrap">
        ...
        <nav id="menu">
          <li><a>Menu 1</a></li>
          <li class="drop">
            <a @click="displayDropMenu">Menu 2 dropdown <i class="icon-arrow"></i></a>
            <ul class="drop_menu">
              <a>Sub menu 1</a>
              <a>Sub menu 2</a>
              <a>Sub menu 3</a>
          ...
          <li class="drop">
            <a @click="displayDropMenu">Menu 3 dropdown <i class="icon-arrow"></i></a>
            <ul class="drop_menu">
              <a>Sub menu 1</a>
              <a>Sub menu 2</a>
              <a>Sub menu 3</a>
  ...
  export default {
    ...
    methods: {
      ...
      displayDropMenu(event) {
        var dropMenu = event.target.parentElement.getElementsByClassName("drop_menu")[0];
        var dropMenus = document.getElementsByClassName("drop_menu");
